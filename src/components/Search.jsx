...
function Search() {
  return (
    <div className='flex relative justify-center flex-col'>
      <div className='flex flex-col md:gap-4 text-center text-cyan-950 font-bold bg-white/40 absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-2/3 z-10 w-full md:mt-5 md:p-5'>
